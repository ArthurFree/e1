    ...
    [
      {
        ...
        run: () => {
          if (row !== null && row > 0) moveRow(editor, row, row - 1);
        },
      },
      {
        id: "rowDown",
        ...
        disabled: row === null,
        run: () => {
          if (row !== null) moveRow(editor, row, row + 1);
        },
      },
      {
        id: "colLeft",
        label: "列左移",
        disabled: col === null || col <= 0,
        run: () => {
          if (col !== null && col > 0) moveColumn(editor, col, col - 1);
        },
      },
      {
        id: "colRight",
        ...
        disabled: col === null,
        run: () => {
          if (col !== null) moveColumn(editor, col, col + 1);
        },
      },
      {
        id: "sortAsc",
        ...
        disabled: col === null,
        run: () => {
          if (col !== null) sortByColumn(editor, col, "asc");
        },
      },
      {
        id: "sortDesc",
        ...
        disabled: col === null,
        run: () => {
          if (col !== null) sortByColumn(editor, col, "desc");
        },
      },
    ],
  ];
