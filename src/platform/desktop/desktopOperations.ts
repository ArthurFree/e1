 ...
 * - page.renameFile = false：Main IPC（note.renameFile）已就绪，但领域
 *   PageRepository 接口无此方法、UI 入口属后续批次，本批不接线（§4.4 P2）；
 * - page.move 仅 document → directory（分组移动/重命名待 Main 目录 IPC）；
